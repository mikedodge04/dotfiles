...
augroup fswitch_au_group
    au!
    au BufEnter *.h call s:SetVariables('cpp,c,m', 'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|../Sources|')
    au BufEnter *.c,*.cpp,*.m call s:SetVariables('h', 'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|../Headers|')
augroup END
